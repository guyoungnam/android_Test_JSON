package org.techtown.jsonexample;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycleView = (RecyclerView) findViewById(R.id.resultRv);
    ...
    } // 데이터를 JSONObject 보내고 받는 방법, Send Object
    ...
    private void receiveObject(JSONObject data) {
        ...
        try {
            ...
            mReceiveNameTv.setText("name : " + data.getString("name"));
    ...
    }// 데이터를 JSONArray로 보내고 받는 방법, 서버에서 배열 데이터를 전송 받을 때
